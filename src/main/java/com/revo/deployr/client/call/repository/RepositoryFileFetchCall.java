...
/**
 * Provides support for DeployR API call: /r/repository/file/fetch.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class RepositoryFileFetchCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RREPOSITORYFILEFETCH;

    public RepositoryFileFetchCall(String filename,
                                   String directory,
                                   String author,
                                   String version) {
