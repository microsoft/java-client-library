...
/**
 * Provides support for DeployR API call: /r/project/workspace/save.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectWorkspaceSaveCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTWORKSPACESAVE;

    public ProjectWorkspaceSaveCall(String project, String name, String descr, boolean version) {
