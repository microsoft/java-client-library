/*
 * RepositoryDirectoryUploadCall.java
 *
 ...
 */
public class RepositoryDirectoryUploadCall extends AbstractCall
        implements Callable<RCoreResult> {

    private Log log = LogFactory.getLog(RepositoryDirectoryUploadCall.class);

    private InputStream zipStream;
    private RepoUploadOptions options;

    private final String API = REndpoints.RREPOSITORYDIRECTORYUPLOAD;

    public RepositoryDirectoryUploadCall(InputStream zipStream,
