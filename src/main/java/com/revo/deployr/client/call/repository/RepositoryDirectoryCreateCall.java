/*
 * RepositoryDirectoryCreateCall.java
 *
...
/**
 * Provides support for DeployR API call: /r/repository/directory/create.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class RepositoryDirectoryCreateCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RREPOSITORYDIRECTORYCREATE;

    public RepositoryDirectoryCreateCall(String newDirectoryName) {
        httpParams.put("directory", newDirectoryName);
