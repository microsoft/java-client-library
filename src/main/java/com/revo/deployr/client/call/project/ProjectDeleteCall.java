...
/**
 * Provides support for DeployR API call: /r/project/delete.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectDeleteCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTDELETE;

    public ProjectDeleteCall(RProjectDetails details) {
