...
/**
 * Provides support for DeployR API call: /r/project/grant.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectGrantCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTGRANT;

    public ProjectGrantCall(String project, String username) {
        httpParams.put("project", project);
        httpParams.put("newauthor", username);
