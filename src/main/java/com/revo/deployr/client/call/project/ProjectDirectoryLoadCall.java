...
/**
 * Provides support for DeployR API call: /r/project/directory/load.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectDirectoryLoadCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTDIRECTORYLOAD;

    public ProjectDirectoryLoadCall(String project,
                                    String filename,
                                    String directory,
                                    String author,
                                    String version) {
