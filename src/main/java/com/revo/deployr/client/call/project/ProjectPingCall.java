...
/**
 * Provides support for DeployR API call: /r/project/ping.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectPingCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTPING;

    public ProjectPingCall(String project) {
