...
/**
 * Provides support for DeployR API call: /r/project/execute/flush.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectExecuteFlushCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTEXECUTEFLUSH;

    public ProjectExecuteFlushCall(String project, String execution) {
