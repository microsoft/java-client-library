...
/**
 * Provides support for DeployR API call: /r/repository/script/list.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class RepositoryScriptListCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RREPOSITORYSCRIPTLIST;

    public RepositoryScriptListCall(boolean archived,
                                    boolean shared,
                                    boolean published,
                                    String filename,
                                    String directory) {
