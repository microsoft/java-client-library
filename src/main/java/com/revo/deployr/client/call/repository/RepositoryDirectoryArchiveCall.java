/*
 * RepositoryDirectoryArchiveCall.java
 *
...
/**
 * Provides support for DeployR API call: /r/repository/directory/archive.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class RepositoryDirectoryArchiveCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RREPOSITORYDIRECTORYARCHIVE;

    public RepositoryDirectoryArchiveCall(RRepositoryDirectoryDetails details,
                                          String archiveDirectoryName,
                                          List<String> files) {

        httpParams.put("directory", details.name);
        httpParams.put("archive", archiveDirectoryName);
