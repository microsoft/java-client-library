...
/**
 * Provides support for DeployR API call: /r/user/release.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectReleaseCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RUSERRELEASE;

    public ProjectReleaseCall() {
