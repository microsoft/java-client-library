 ...
 */
public class ProjectPoolCall extends AbstractCall implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTPOOL;

    public ProjectPoolCall(int poolsize, ProjectCreationOptions options) throws RDataException {

        httpParams.put("poolsize", Integer.toString(poolsize));
