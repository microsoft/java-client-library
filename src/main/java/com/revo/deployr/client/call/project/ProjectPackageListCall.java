...
/**
 * Provides support for DeployR API call: /r/project/package/list.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectPackageListCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTPACKAGELIST;

    public ProjectPackageListCall(String project, boolean installed) {
        httpParams.put("project", project);
        httpParams.put("installed", Boolean.toString(installed));
