/*
 * ProjectExecuteInterruptCall.java
 *
...
/**
 * Provides support for DeployR API call: /r/project/execute/interrupt.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectExecuteInterruptCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTEXECUTEINTERRUPT;

    public ProjectExecuteInterruptCall(String project) {
