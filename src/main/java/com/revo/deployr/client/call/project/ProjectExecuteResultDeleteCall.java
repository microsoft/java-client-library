/*
 * ProjectExecuteResultDeleteCall.java
 *
...
/**
 * Provides support for DeployR API call: /r/project/execute/result/delete.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectExecuteResultDeleteCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTEXECUTERESULTDELETE;

    public ProjectExecuteResultDeleteCall(String project, String execution, String filename) {
        httpParams.put("project", project);
        httpParams.put("execution", execution);
