/*
 * RepositoryScriptInterruptCall.java
 *
...
/**
 * Provides support for DeployR API call: /r/repository/script/interrupt.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class RepositoryScriptInterruptCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RREPOSITORYSCRIPTINTERRUPT;

    public RepositoryScriptInterruptCall() {
