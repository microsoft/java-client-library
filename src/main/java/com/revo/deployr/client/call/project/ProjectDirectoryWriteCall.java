/*
 * ProjectDirectoryWriteCall.java
 *
...
/**
 * Provides support for DeployR API call: /r/project/directory/write.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectDirectoryWriteCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTDIRECTORYWRITE;

    public ProjectDirectoryWriteCall(String project, String text, DirectoryUploadOptions options) {
