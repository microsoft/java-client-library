...
/**
 * Provides support for DeployR API call: /r/user/about.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class AboutCall extends AbstractCall implements Callable<RCoreResult> {

    private final String API = REndpoints.RUSERABOUT;
