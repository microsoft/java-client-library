/*
 * ProjectWorkspaceDeleteCall.java
 *
...
/**
 * Provides support for DeployR API call: /r/project/workspace/delete.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectWorkspaceDeleteCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTWORKSPACEDELETE;

    public ProjectWorkspaceDeleteCall(String project, List<String> objects) {
