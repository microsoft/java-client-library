...
/**
 * Provides support for DeployR API call: /r/project/package/attach.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectPackageAttachCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTPACKAGEATTACH;

    public ProjectPackageAttachCall(String project, List<String> packageNames, String repo) {
