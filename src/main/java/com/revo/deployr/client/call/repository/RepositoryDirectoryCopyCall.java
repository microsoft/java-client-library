/*
 * RepositoryDirectoryCopyCall.java
 *
...
/**
 * Provides support for DeployR API call: /r/repository/directory/copy.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class RepositoryDirectoryCopyCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RREPOSITORYDIRECTORYCOPY;

    public RepositoryDirectoryCopyCall(String directory,
                                       String destination,
                                       List<String> files) {
