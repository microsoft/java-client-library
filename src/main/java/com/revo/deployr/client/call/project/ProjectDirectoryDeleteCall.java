/*
 * ProjectDirectoryDeleteCall.java
 *
...
/**
 * Provides support for DeployR API call: /r/project/directory/delete.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectDirectoryDeleteCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTDIRECTORYDELETE;

    public ProjectDirectoryDeleteCall(String project, String filename) {
