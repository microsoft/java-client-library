/*
 * ProjectExecuteResultListCall.java
 *
...
/**
 * Provides support for DeployR API call: /r/project/execute/result/list.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class ProjectExecuteResultListCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RPROJECTEXECUTERESULTLIST;

    public ProjectExecuteResultListCall(String project, String execution) {
