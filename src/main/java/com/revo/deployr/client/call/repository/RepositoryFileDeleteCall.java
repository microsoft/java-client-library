...
/**
 * Provides support for DeployR API call: /r/repository/file/delete.
 * <p/>
 * Simply construct an instance of this call and pass it on the
 * execute() method of your {@link com.revo.deployr.client.RClient}.
 */
public class RepositoryFileDeleteCall extends AbstractCall
        implements Callable<RCoreResult> {

    private final String API = REndpoints.RREPOSITORYFILEDELETE;

    public RepositoryFileDeleteCall(RRepositoryFileDetails repoFile) {
